      ...
      <div className="relative h-full flex flex-col justify-center gap-6 py-4 sm:py-6 px-4 sm:px-8 overflow-hidden">
        <div className="relative flex justify-between w-full h-full items-stretch flex-col">
          <div className="absolute h-full w-full aspect-[578/433] shadow-2xl rounded-lg">
            <Image
              src={"/projects/acnew.jpg"}
              alt={"FixYourAc landing page example"}
              fill
              style={{
                objectFit: "cover",
                objectPosition: "top",
        ...
        <div className="flex flex-col items-start gap-1">
          ...
          <div className="w-full flex gap-2 items-center">
            ...
            <SendmessageIcon link="https://www.fixyourac.in/" lottieName="fixyourac" />
            <GitHubIcon link={"https://github.com/kichuu/ac-service-center"} lottieName={"fixyourac"}/>
          </div>
